...
class BackupsViewModel
    ...
    constructor(
        ...
        fun updateMarkdownEnabled(enabled: Boolean) {
            context
                .getSharedPreferences("markdown_sync_prefs", Context.MODE_PRIVATE)
                .edit()
        ...
        fun refreshAndroidBackupSummary(
            timestamp: Long? = null,
            preferencesViewModel: PreferencesViewModel,
        ) {
